...
class fs_cmodule_widget extends WP_Widget {
	...
	function fs_cmodule_widget() {
		...
		$widget_ops = array( 'classname' => 'fs_cmodule_widget', 'description' => __('This widget shows the latest posts from a selected category, built for Homepage Middle Section.', 'fs_cmodule_widget') );
		...
		$this->WP_Widget( 'fs_cmodule_widget', __('Firestarter Homepage Module-C', 'fs_cmodule_widget'), $widget_ops );
...
<div class="homecompactimgfirst"><?php if ( has_post_thumbnail() ) {the_post_thumbnail('homecompactthumb');} ?></div><!-- /homecompactimgfirst -->

<div class="homecompactimgsecond"><?php if (class_exists('MultiPostThumbnails')) : MultiPostThumbnails::the_post_thumbnail(get_post_type(), 'secondary-image', NULL, 'homecompactthumb'); endif; ?></div><!-- /homecompactimgsecond -->
...
<div class="compactstarswrapper"><span class="thumbstarunder"><span class="thumbstartop" style="width:<?php echo $tf_final_percentage;?>%"></span></span></div>	
			<?php } else { ?>					
			<?php } ?>
...
<div class="homecompactexcerpt"><p><?php echo strip_tags(excerpt(12)); ?></p></div><!-- /homecompactexcerpt -->
