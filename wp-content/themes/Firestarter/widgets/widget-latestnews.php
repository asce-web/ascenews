...
class fs_latestnews_widget extends WP_Widget {
	...
	function fs_latestnews_widget() {
		...
		$widget_ops = array( 'classname' => 'fs_latestnews_widget', 'description' => __('This widget shows the latest news from a selected category, built for Homepage Left Sidebar.', 'fs_latestnews_widget') );
		...
		$this->WP_Widget( 'fs_latestnews_widget', __('Firestarter Homepage Latest News', 'fs_latestnews_widget'), $widget_ops );
...
<div class="newsposttitle"><h1><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1></div><!-- /newsposttitle -->
