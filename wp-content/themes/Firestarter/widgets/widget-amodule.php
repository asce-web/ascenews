...
class fs_amodule_widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            false, // Base ID
            'Firestarter Homepage Module-A', // Name
    ...
    function widget($args, $instance)
    {
        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <div class="homedoubleimg">
                ...
                <div class="homedoubleimgfirst"><?php if (has_post_thumbnail()) {
                        the_post_thumbnail('homedoublethumb');
                    } ?></div><!-- /homedoubleimgfirst -->

                <div class="homedoubleimgsecond"><?php if (class_exists('MultiPostThumbnails')) : MultiPostThumbnails::the_post_thumbnail(get_post_type(), 'secondary-image', NULL, 'homedoublethumb'); endif; ?></div>
                <!-- /homedoubleimgsecond -->
                ...
                <?php if ($tf_review_enable == 1) { ?>
                    <div class="thumbstarswrapper"><span class="thumbstarunder"><span class="thumbstartop"
        ...
        <div id="homedoubleright">
            ...
            <?php if (have_posts()) : ?>
                <?php while (have_posts()) : the_post(); ?>
                    ...
                    <div class="homepostexcerpt"><p><?php echo strip_tags(excerpt(8)); ?></p>
                    </div><!-- /homepostexcerpt -->
                    ...
                    <div class="homepostsinfo">
                        ...
                        <div class="homepostsauthormeta"><?php the_author_posts_link(); ?></div>
                        <!-- /homepostsauthormeta -->
            ...
            <?php if (have_posts()) : ?>
                <?php while (have_posts()) : the_post(); ?>
                    ...
                    <div class="homedoublesmall">
                        ...
                        <div class="homedoublesmallimg"><a
                                    href="<?php the_permalink() ?>"><?php if (has_post_thumbnail()) {
                                    the_post_thumbnail('homedoublesmallthumb');
                                } ?></a>
