...
class fs_columnists_widget extends WP_Widget
{
    ...
    function fs_columnists_widget()
    {
        parent::__construct(
            false, // Base ID
            'Firestarter Homepage Columnists Section', // Name
            array('description' => 'This widget shows the latest posts of selected authors, built for Homepage Left Sidebar.',) // Args
        );
    }
                ...
                <div class="columnistsbox">
                    ...
                    <?php if (have_posts()) : ?>
                        <?php while (have_posts()) : the_post(); ?>
                            ...
                            <div class="columnistsposttitle"><h1><a
                                            href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1></div>
                            ...
                            <?php if ($tf_review_enable == 1) { ?>
                                <span class="homestarsunder"><span class="homestarsover"
                            ...
                            <div class="colpostsinfo">
                                ...
                                <div class="homepostsmeta"><?php the_time(get_option('date_format')); ?> | by&nbsp;
                                </div><!-- /homepostsmeta -->

                                <div class="homepostsauthormeta"><a
                                            href="<?php echo get_author_posts_url($colauthor1); ?>"><?php echo $name; ?></a>
                                </div><!-- /homepostsauthormeta -->
                    ...
                    <?php if (have_posts()) : ?>
                        <?php while (have_posts()) : the_post(); ?>
                            ...
                            <div class="colpostsinfo">
                                ...
                                <div class="homepostsauthormeta"><a
                                            href="<?php echo get_author_posts_url($colauthor2); ?>"><?php echo $name; ?></a>
                                </div><!-- /homepostsauthormeta -->
                    ...
                    <?php if (have_posts()) : ?>
                        <?php while (have_posts()) : the_post(); ?>
                            ...
                            <div class="colpostsinfo">
                                ...
                                <div class="homepostsauthormeta"><a
                                            href="<?php echo get_author_posts_url($colauthor3); ?>"><?php echo $name; ?></a>
                                </div><!-- /homepostsauthormeta -->
                    ...
                    <?php if (have_posts()) : ?>
                        <?php while (have_posts()) : the_post(); ?>
                            ...
                            <div class="colpostsinfo">
                                ...
                                <div class="homepostsauthormeta"><a
                                            href="<?php echo get_author_posts_url($colauthor4); ?>"><?php echo $name; ?></a>
                                </div><!-- /homepostsauthormeta -->
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <input id="<?php echo $this->get_field_id('colauthor1'); ?>"
                   name="<?php echo $this->get_field_name('colauthor1'); ?>"
                   value="<?php echo $instance['colauthor1']; ?>" style="width:90%;"/>
        ...
        <p>
            ...
            <input id="<?php echo $this->get_field_id('colauthor2'); ?>"
                   name="<?php echo $this->get_field_name('colauthor2'); ?>"
                   value="<?php echo $instance['colauthor2']; ?>" style="width:90%;"/>
        ...
        <p>
            ...
            <input id="<?php echo $this->get_field_id('colauthor3'); ?>"
                   name="<?php echo $this->get_field_name('colauthor3'); ?>"
                   value="<?php echo $instance['colauthor3']; ?>" style="width:90%;"/>
        ...
        <p>
            ...
            <input id="<?php echo $this->get_field_id('colauthor4'); ?>"
                   name="<?php echo $this->get_field_name('colauthor4'); ?>"
                   value="<?php echo $instance['colauthor4']; ?>" style="width:90%;"/>
