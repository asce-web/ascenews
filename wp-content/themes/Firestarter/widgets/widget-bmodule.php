...
class fs_bmodule_widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            false, // Base ID
            'Firestarter Homepage Module-B', // Name
    ...
    function widget($args, $instance)
    {
        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <div id="homeonebigimg">
                <div class="homeonebigimgfirst"><?php if (has_post_thumbnail()) {
                        the_post_thumbnail('homeonebigthumb');
                    } ?></div><!-- /homeonebigimgfirst -->

                <div class="homeonebigimgsecond"><?php if (class_exists('MultiPostThumbnails')) : MultiPostThumbnails::the_post_thumbnail(get_post_type(), 'secondary-image', NULL, 'homeonebigthumb'); endif; ?></div>
                <!-- /homeonebigimgsecond -->
            ...
            <?php if (have_posts()) : ?>
                <?php while (have_posts()) : the_post(); ?>
                    <div class="homeonebigsmall">
                        <div class="homeonebigsmallimg"><a
                                    href="<?php the_permalink() ?>"><?php the_post_thumbnail('homeonebigsmallthumb'); ?>
                ...
                <?php while (have_posts()) : the_post(); ?>
                    <div id="homeonebigsmallend">
                        <div class="homeonebigsmallimg"><a
                                    ...
                                    the_post_thumbnail('homeonebigsmallthumb');
                                } ?>
                                <?php if (has_post_format('quote')) {
                                    echo '<img src="' . get_template_directory_uri() . '/images/quotebig.png" alt="watermark" class="watermark" height="64px" width="64px" />';
                                } elseif (has_post_format('gallery')) {
