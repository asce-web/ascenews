...
class RpsWidget extends WP_Widget {
    ...
    function RpsWidget() {
        ...
        parent::WP_Widget(false, $name = 'Recent Posts Slider', array( 'description' => __( 'Your blogs recent post using slider', 'TF_EN') ));	
    ...
    function form($instance) {				
        ...
        ?>
            ...
            <p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'TF_EN'); ?> <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></label></p>
