...
<p>
	In this page you can customize the featured slider. Category selection only applies to homepage featured slider since the category page sliders automaticly shows the latest posts of the respective categories. Recommended settings are: Width:637, No. of post:1, Height:470, Slider Speeed:3, Total Post:8, Pagination Style:Dots, Slider Content:Show Both, Excerpt Words:35, Text Before Date:Selected and the Category ID according to your featured category. Please leave other areas empty. 
</p>
