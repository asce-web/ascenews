...
<div id="da-slider" class="da-slider">
	<div class="da-slide">
		...
		<a href="$plugin_abs_path/images/1.png" class="da-link">$read_more</a>
		<div class="da-img"><img src="$plugin_abs_path/images/1.png" alt="image01" /></div>
	</div>
	<div class="da-slide">
		<h2>Wonderful design</h2>
		<p>This plugin is written upon the code of <a href="$plugin_abs_path/images/1.png" target="_blank">Manoella Ilic</a>, you can see the simple JQuery and CSS version <a href="$plugin_abs_path/images/1.png" target="_blank">here</a>.</p>
		<a href="$plugin_abs_path/images/1.png" class="da-link">$read_more</a>
