...
<?php if($dates_opt_val=='checked') { ?><span class="tickerDate"><?php echo $date; ?></span> - <?php } ?><span class="tickerLink"><a href="<?php echo $link; ?>"><?php echo $title;?></a></span><?php if($content_opt_val=='checked') { ?> <span class="tickerText">- <a href="<?php echo $link; ?>">Read More &rarr; </a></span><span class="tickerfiller">. . . . .</span><?php } ?></li>
...
function ticker_set_default_options() {
  ...
  if(get_option('ticker_auto_excerpt_length')===false)		    add_option('ticker_auto_excerpt_length', 0);
  ...
  if(get_option('ticker_speed')===false)		                add_option('ticker_speed', 3);

  if(get_option('ticker_timeout')===false)		                add_option('ticker_timeout', 1);
...
function ticker_add_pages() {
	...
	add_theme_page('News Ticker', 'News Ticker', 'edit_plugins', 'tickeroptions', 'ticker_options_page');
...
function ticker_options_page() {
	...
	$ticker_speed_opt_val = '3';

	$ticker_timeout_opt_val = '1';

	$ticker_anim_opt_val = 'scrollLeft';

	$ticker_ht_opt_val = '20';
    ...
    ?>
      ...
      <tr valign="top" class="post-extra gre">
        ...
        <td>
          ...
          <input checked="checked" type="checkbox" name="<?php echo $content_opt_name; ?>" <?php if (isset($content_opt_name)) { echo 'value="checked"'; }?> <?php if($content_opt_val=='checked') { echo 'checked'; } ?>>
